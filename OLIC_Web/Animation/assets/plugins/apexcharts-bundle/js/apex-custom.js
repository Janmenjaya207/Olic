$(function () {
    ...
    var options = {
        series: [{
            data: [1000, 1500, 2000, 7000, 8000, 2350, 10000, 15000, 200]
        }],
        chart: {
            foreColor: '#9ba7b2',
            type: 'bar',
        ...
        xaxis: {
            categories: ['2014-15', '2015-16', '2016-17', '2017-18', '2018-19', '2019-20', '2020-21', '2021-22', '2022-23'],
        }
    };
    ...
    var options = {
        ...
        colors: ["#0d6efd", "#21ad42", "#fc0317"],
        labels: ['Pending', 'Feasible', 'Not Feasible'],
        responsive: [{
            breakpoint: 480,
            options: {
                chart: {
